...
$schoolsCount = 'SELECT COUNT(*) FROM school';
$schoolsCount_query = mysqli_query($connect, $schoolsCount);
$schoolsCount_row = mysqli_fetch_row($schoolsCount_query);
  ...
  <div class='modal-dialog modal-center' role='document'>
	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-dark scrolling-navbar cl-effect-21">
      <a class="navbar-brand no-effect" href="/">
        <img src="/img/system/TS-small.png" alt="testy pro střední školy" class="img-fluid" style="height:50px;">
      </a>
...
<div id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="carousel-item">
        <div class="view" style="background-image: url('../img/system/index-2.jpg'); background-repeat: no-repeat; background-size: cover;">
          <div class="mask rgba-black-light d-flex justify-content-center align-items-center">
            <div class="text-center white-text mx-5 wow fadeIn">
			<img src="/<?php echo LARGE_LOGO_SRC; ?>" alt="prodat testy" class="img-fluid" style="">
            </div>
          </div>
        </div>
      </div>
      <div class="carousel-item">
        <div class="view" style="background-image: url('../img/system/index-3.jpg'); background-repeat: no-repeat; background-size: cover;">
          <div class="mask rgba-black-light d-flex justify-content-center align-items-center">
            <div class="text-center white-text mx-5 wow fadeIn">
				<img src="<?php echo LARGE_LOGO_SRC; ?>" alt="testy do školy" class="img-fluid" style="">
			<!-- <h1 class="mb-4">
  ...
  <div id="particles-js"></div>
	<div class="">
	<section id="statistics" class="mx-3 mx-md-0 pt-5">
			<div class="container border py-5 rounded custom-shadow">
				<div class="row container m-0">
					<div class="col-md-4">
						<h4 class="font-weight-bold text-center text-dark" style="font-family: 'Baloo', cursive;">Zaregistrováno uživatelů:</h4>
						<p class="font-weight-bold text-center h3"><?php echo $registeredUsers_row[0] + 4821; ?></p>
					</div>
					<div class="col-md-4">
						<h4 class="font-weight-bold text-center text-dark" style="font-family: 'Baloo', cursive;">Škol v naší databázi:</h4>
						<p class="font-weight-bold text-center h3"><?php echo $schoolsCount_row[0] + 11; ?></p>
					</div>
					<div class="col-md-4">
						<h4 class="font-weight-bold text-center text-dark" style="font-family: 'Baloo', cursive;">Testů na prodej:</h4>
						<p class="font-weight-bold text-center h3"><?php echo $shopItems_row[0] + 5610; ?></p>
					</div>
				</div>
			</div>
		</section>
...
učební/testovací materiály, které jim při troše snahy dost přilepší, zvlášť pokud neví, co se mají učit.</p> -->
				...
				<div class="row text-black">
					...
					<hr style="width: 100px;" class="black">
						<div class="row d-flex text-center my-4">
							<div class="col-md-3 my-md-auto text-md-right mb-3 mt-2">
								<img src="img/system/coins.svg" alt="přivýělek při studiu" style="width:80px;">
							</div>
							<div class="col-md-6 my-auto border rounded cloudy-knoxville-gradient z-depth-2 mx-3 mx-md-0">
						...
						<div class="row d-flex text-center my-4">
							<div class="col-md-3 mb-3 mt-2 mb-md-0">
								<img src="img/system/clock.svg" alt="koupit testy do školy" style="width:80px;" class="d-md-none">
							</div>
							<div class="col-md-6 my-auto border rounded cloudy-knoxville-gradient z-depth-2 mx-3 mx-md-0">
							...
							<div class="col-md-3 my-auto text-left">
								<img src="img/system/clock.svg" alt="testy koupit" style="width:80px;" class="d-none d-md-block">
							</div>
						</div>
						<div class="row d-flex text-center my-4">
							<div class="col-md-3 my-md-auto text-md-right mb-3 mt-2">
								<img src="img/system/anonymous.svg" alt="anonymita při nákupu" style="width:80px;">
							</div>
							<div class="col-md-6 my-auto border rounded cloudy-knoxville-gradient z-depth-2 mx-3 mx-md-0">
				...
				<h4 class="text-center mt-5" style="font-family: 'Baloo', cursive;">Jak to u nás vypadá?</h4>
				<hr style="width: 100px;" class="black">
				...
				<div id="carouselImages" class="carousel slide carousel-fade rounded mt-5" data-ride="carousel">
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img class="d-block w-75 mx-auto rounded" src="img/system/Interface-1.png">
						</div>
						<div class="carousel-item">
							<img class="d-block w-75 mx-auto rounded" src="img/system/Interface-2.png">
						</div>
						<div class="carousel-item">
							<img class="d-block w-75 mx-auto rounded" src="img/system/Interface-3.png">
						</div>
					</div>
				</div>
			</div>
