...
require_once '../../scripts/ip_check.php';
	...
	full_register();
	page_start("Žádosti o změnu školy");
	display_messages();
	update_activity();

?>
	<div class="container my-4">
		<h4 class="text-center font-weight-bold mt-4" style="font-family: 'Baloo', cursive;"><i class="fas fa-school"></i> Žádosti o změnu školy</h4>
...
?>
  ...
  <script type="text/javascript" src="js/ajax-school-check.js"></script>
