...
<div class="" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
    <div class="d-flex">
        <i class="fas fa-check mx-auto fa-10x mb-3 animated rotateIn text-success"></i>
    </div>
      <p class="text-center font-weight-bold my-4">Úspěšná platba. Peníze budou zaúčtovány na Vaše konto do 24 hodin.</p>
